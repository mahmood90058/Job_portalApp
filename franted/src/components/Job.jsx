...
const Job = ({job}) => {
  ...
  return (
    <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100'>
        ...
        <div>
            <h1 className='font-medium text-gray-600'>{job?.company?.name}</h1>
            <p>India</p>
        </div>
        ...
        <div>
          ...
          <div className='flex items-center gap-2 mt-4'>
            ...
            <div className='flex items-center gap-4 mt-4 '>
                <Button className="cursor-pointer" varient="outline"  onClick={()=>navigate(`/description/${job._id}`) } >Details</Button>
                <Button    className="bg-purple-700 cursor-pointer">Save For Later</Button>
